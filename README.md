...
Raspberry Pi sends images to the server
Server processes images using MediaPipe Pose
Body landmarks are analyzed
Fall detection algorithm determines fall state
